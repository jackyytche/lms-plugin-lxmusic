...
sub prefs {
	return ($prefs, qw(
		...
		boardsKg boardsTx boardsWy boardsMg qualityFallback verifyUrl
	));
}

my @BOOL_PREFS = qw(coverProxy boardsKg boardsTx boardsWy boardsMg qualityFallback verifyUrl);
